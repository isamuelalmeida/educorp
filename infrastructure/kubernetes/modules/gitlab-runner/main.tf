...
resource "helm_release" "gitlab_runner_platos" {
  name       = "gitlab-runner-platos"
  repository = "https://charts.gitlab.io"
  ...
  set {
    name  = "runnerRegistrationToken"
    value = data.aws_ssm_parameter.gitlab_runner_registration_token_platos.value
  }
...
resource "helm_release" "gitlab_runner_portalpos" {
  name       = "gitlab-runner-portalpos"
  repository = "https://charts.gitlab.io"
  ...
  set {
    name  = "runnerRegistrationToken"
    value = data.aws_ssm_parameter.gitlab_runner_registration_token_portalpos.value
  }
